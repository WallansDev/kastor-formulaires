        ...
        <div class="row mb-5">
            <form method="POST" action="{{ route('yeastar.extension') }}">
                ...
                <small><i><u>Numéros indisponibles :</u></i>
                    ...
                    <i><b>NB : </b>Pour utiliser la plage 3XXX, l'ajout d'un préfixe '0' est nécessaire. Exemple : 03XXX</i>
                </small>

                <br>
                <button type="button" class="btn-add mt-3" onclick="addRow()"><i class="fa fa-plus" aria-hidden="true"></i>
                    ...
                    <table class="table table-hover table-bordered table-striped">
                        ...
                        <tbody id="tableExt">
                            @php
                                $extensions = old(
                                    'extensions',
                                    session('form_yeastar.extensions', [
                                        [
                                            'extension' => '',
                                            'name' => '',
                                            'email' => '',
