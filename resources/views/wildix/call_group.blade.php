...
@section('title', 'Groupes de sonneries et Queues')
...
@section('content')
    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('wildix.call_group') }}">
            ...
            <div class="row mt-5">
                <div class="col-6">
                    <h4>Créer un groupe de sonnerie</h4>
                </div>
                <div class="col-1"></div>
                <div class="col-5">
                    <h4>Groupes de sonneries et Queues existants</h4>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <h4>Créer une queue d'appel</h4>

                    <div class="col-8">
                        <input type="text" name="qName" placeholder="Nom de la queue" class="form-control my-2"
                            value="{{ old('qName') }}">
                ...
                <div class="col-1"></div>
                <div class="col-5">
                    <p class="mt-3">--- Groupes de sonneries ---</p>
                    ...
                    @empty
                        <p>Aucun queue d’appel pour le moment.</p>
                    @endforelse
            ...
            <div class="row mt-5">
                <h4>Associer une extension à un groupe ou queue d'appel</h4>
            </div>
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <select name="cg_selectionne" class="form-control">
                                <option value="" disabled selected>-- Choisir le groupe ou queue --</option>
                                @if (count($callGroups) > 0)
                                    <optgroup label="Groupes de sonneries">
            ...
            <div class="mt-5 mb-3">
                <a href="{{ route('wildix.timetable') }}" style="float:right;" class="btn btn-success">Suivant</a>
            </div>
