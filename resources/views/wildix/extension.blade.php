...
@section('content')
    <div class="container">
                ...
                <div class="row mt-2">
                    <table class="table table-hover table-bordered table-striped">
                        ...
                        @if (empty($extensions))
                            <tbody id="tableExt">
                                @php
                                    $extensions = old('extensions', session('form_wildix.extensions', []));
                                @endphp
                                        ...
                                        <td>
                                            <select name="extensions[{{ $i }}][numPorte]" class="form-control"
                                                ...
                                                <option value="" disabled
                                                    {{ old('extensions.' . $i . '.numPorte', $ext['numPorte'] ?? '') == '' ? 'selected' : '' }}>
                                                    --- Sélectionner le numéro porté ---</option>

                                                @foreach ($data['portes'] as $porte)
                                                    <option value="{{ $porte['numero'] }}"
                                                        {{ old('extensions.' . $i . '.numPorte', $ext['numPorte'] ?? '') == $porte['numero'] ? 'selected' : '' }}>
                                                        {{ $porte['numero'] }}
                                                    </option>
                                                @endforeach
                                            </select>
        ...
        <script>
            ...
            <td><select name="extensions[${currentIndex}][licence]" class="form-control" required>
